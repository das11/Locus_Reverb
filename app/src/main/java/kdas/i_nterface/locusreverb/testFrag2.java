...
public class testFrag2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View baseView = inflater.inflate(R.layout.fragment_test_frag2, container, false);
        ...
        recyclerView = (RecyclerView)baseView.findViewById(R.id.rv_schedule_p);
        down = (ImageView)baseView.findViewById(R.id.down_p);
        final com.github.sundeepk.compactcalendarview.CompactCalendarView month_view = (com.github.sundeepk.compactcalendarview.CompactCalendarView)baseView.findViewById(R.id.compactcalendar_view_p);
        ...
        month_name = (TextView)baseView.findViewById(R.id.month_name_p);
        ...
        adapter = new rv_event_adapter_p(getContext(), mevents);
